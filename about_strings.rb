...
#FIXME: find the difference between these types of strings
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # The shovel operator modifies the string, while the += creates a
    # copy and replaces the string.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    #
    # A bit, yeah. Strings are supposed to begin at zero, really. You
    # may do as you please, but numbers start at zero. That's how it works.
  end
