...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # The only case I can think at the moment is when the string is
    # nil. Otherwise, it will always match, at least with an empty
    # string.
  end
  ...
  # Why?
  #
  # Because they don't return the result of the first match, they will
  # always try to give the most broad match they can.
  ...
  #
  # A character class is unordered in terms of match, the alternation
  # requires the characters to be in the order specified.
