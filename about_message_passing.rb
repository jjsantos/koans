...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # We could define method_missing such as follows:
    #
    # def method_missing(method_name)
    #     !self.respond_to?(method_name)
    # end
    #
    # If we do this, we'll have two immediate consequences:
    #
    # 1. Calls to non existent methods will no longer raise the
    # NoMethodError exception
    #
    # 2. There will be no way to know if a certain method correctly
    # responds to a call or not.
    #
    # NOTE:
    #
